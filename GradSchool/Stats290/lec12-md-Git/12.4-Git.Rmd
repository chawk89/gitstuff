...
8. Go back to `master` branch on the Github Desktop.

9. Switch back and forth between `branch1` and `master` to see what
   your file explorer or finder sees in those files. 
